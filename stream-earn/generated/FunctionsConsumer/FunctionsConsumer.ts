...
export class mintTokens extends ethereum.Event {
  get params(): mintTokens__Params {
    return new mintTokens__Params(this);
  }
}

export class mintTokens__Params {
  _event: mintTokens;
...
export class FunctionsConsumer extends ethereum.SmartContract {
  static bind(address: Address): FunctionsConsumer {
    return new FunctionsConsumer("FunctionsConsumer", address);
  }
